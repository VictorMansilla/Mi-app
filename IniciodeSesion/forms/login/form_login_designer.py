...
class Form_Login_Designer:
    ...
    def __init__(self):
        ...
        logo = utl.leer_imagen("C:\\Users\\User\\Desktop\\tarea\\PYtrabajo\\miapp\\IniciodeSesion\\images\\png.png", (200, 200))
        ...
        inicio = tk.Button(frame_form_fill, text="Iniciar sesion", font=('Times', 15, BOLD), bg="#3a7ff6", bd=0, command=self.verificar)
        inicio.pack(fill=tk.X, padx=20, pady=20)
        inicio.bind("<Return>", (lambda event: self.verificar()))

        inicio = tk.Button(frame_form_fill, text="Registrar Usuario", font=('Times', 15), bg="#fcfcfc", bd=0, fg="#3a7ff6", command=self.User_Register)
        inicio.pack(fill=tk.X, padx=20, pady=20)
        inicio.bind("<Return>", (lambda event: self.User_Register()))
